...
android {
    namespace = "com.saymaven.downloader.japaneseasmr"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.saymaven.downloader.japaneseasmr"
        minSdk = 26
        targetSdk = 36
        versionCode = 1
        versionName = "1.0.0"
...
dependencies {
    ...
    // OkHttp & Jsoup for Scraping & URL probing
    ...
    // Jaudiotagger (Pure Java MP3 ID3v2 tagging)
